...
export default function Landing3(){
    ...
    <Banner text="Venture into uncharted territories" color="black" 
    bgColor="white" fontSize="txt_xl" height="large"></Banner>

    <TabbedImages images={tabbed_images} rowColor="rgb(255,255,255)"/>
    <Spacer h={5}/>
       </>
